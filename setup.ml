...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2cafe6276b40d84e79f2ffcfe4a3e88d) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "Ocaml Monad, Error, Result, And Or_error backed by Jane Street's Async";
          description = None;
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Async_result"; "Async_error"; "Async_or_error"];
                      lib_pack = true;
     ...
     oasis_version = "0.4.6";
     oasis_digest =
       Some "\026\015\017\182\240\027d\222D\001\205\023\175\127\025B";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
